...
class AnimatedTransitioning: NSObject {
    ...
    fileprivate func animatePresentedController(transitionContext: UIViewControllerContextTransitioning) {
        ...
        toView.height = UIScreen.main.bounds.height - 60
        
        transitionContext.containerView.addSubview(toView)
        UIView.animate(withDuration: duration, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: .curveEaseOut, animations: {() -> Void in
